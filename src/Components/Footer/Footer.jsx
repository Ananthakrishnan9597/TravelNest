            ...
            <div className="secContent container">
                <div className="contactDiv flex">
                    ...
                    <div className="inputDiv flex">
                        ...
                        <button data-aos="fade-up" className="btn2 flex" type="submit">
                ...
                <div className="footerCard flex">
                    <div className="footerIntro flex">
                        <div className="logoDiv">
                            <a href="#" className="logo flex"> <MdTravelExplore  className="icon"/>TravelNest.</a>
                        </div>
                        <div data-aos="fade-up" className="footerParagraph">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, doloribus culpa ea perspiciatis unde corporis quibusdam, iste quaerat fugiat voluptatem cum labore, sunt voluptas quis a obcaecati maxime assumenda iusto?</p>
                        </div>
                    ...
                    <div className="footerDiv flex">
                       <small>BEST TRAVELNEST BOOKING WEBSITE</small>
                       <small>Copyrights Reserved - Ananth 2026</small>
                    </div>
                </div>
            </div>
          </section>
